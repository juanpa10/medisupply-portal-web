...
import { InventorySearchComponent } from './components/web/inventory-search/inventory-search.component';
...
const routes: Routes = [
  ...
  { path: 'logistics-inventory', component: InventorySearchComponent },
